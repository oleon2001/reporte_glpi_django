"""
Django settings for reportes_glpi project.
...
SECRET_KEY = 'django-insecure-mm0s*))95%$x()4f7w*a3u46e!1_y*d18t^nb!vdp9^(kqsk*^'
...
ROOT_URLCONF = 'reportes_glpi.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'metricas.context_processors.user_initial',
            ],
        },
    },
]
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 254857600  
...
AUTHENTICATION_BACKENDS = [
    'metricas.auth_backend.GLPIAuthBackend',  # Backend personalizado
